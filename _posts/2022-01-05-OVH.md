...
* Un **[VPS OVH](https://www.ovhcloud.com/fr/vps/)** , [HMS](https://www.hostmyservers.fr/) ou [Move4Data](https://move4data.fr/) (Ce sont des hébergeurs que j'ai vérifié et que je certifie fonctionnels)
* **1 ou plusieurs IP Failover** (Ce sont les IPs supplémentaires que nous utiliserons sur nos différents clients)
...
* **J'ai choisi [OVH](https://www.ovhcloud.com/fr/)**, car c'est un **hébergeur Français** qui propose des **IP Supplémentaires** à **bas prix**, tout en proposant une **excellente qualité** de service et un **[Anti-DDOS basique](https://www.ovh.com/fr/anti-ddos/)**.

### **⚠ Changement de Tarif OVH ⚠**

*OVH ont changé les tarifs de leurs IPs additionnelles (initialement en one-time), elles sont maintenant à un tarif mensuel.*
*Une augmentation progressive des prix est prévue jusqu'à atteindre 1.50€ HT par mois au 1er Septembre 2023*
*Plus d'informations [ici](https://blog.ovhcloud.com/ipv4-additionnelles-nouvelle-tarification/)*

![](https://cdn.discordapp.com/attachments/926788575293472798/1040934850556862464/firefox_Bci5P3w8W7.png)

*Suite à ces changements j'ai changé d'hébergeur, néanmoins, pour un petit nombre d'IP je continue de recommander OVH pour leur fiabilité, stabilité et qualité sans reproche de leur réseau.*
*HostMyServers propose des IP "à vie" encore à l'heure où j'édite cette doc (Novembre 2022), mais le réseau n'est pas aussi propre qu'OVH*
