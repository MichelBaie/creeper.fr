...
![Comment fonctionne l'internet](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-schema-hms.avif)
...
![tarifs HMS](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-prixhms.avif)
...
![Tarif IP HMS](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-prixiphms.avif)
...
![Panel HMS IP](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-ip1.avif)

![Panel HMS IP](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-ip2.avif)
...
![Install VPS](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-panelhmsinstallvps.avif)

**Une fois le VPS installé**, vous **recevrez** les **identifiants** pour s’y connecter sur votre **adresse email** client.

![VPS installé](https://forevercdn.creeper.fr/img/docs/wireguarddocs/doc-hmsmailinstalled.avif)
